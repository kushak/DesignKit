...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Shipulin Oleg/DesignKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Shipulin Oleg' => 'oshipulin@ozon.ru' }
  s.source           = { :git => 'https://github.com/Shipulin Oleg/DesignKit.git', :tag => s.version.to_s }
